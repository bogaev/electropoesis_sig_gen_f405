...
extern "C" inline void GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
...
extern "C" inline void vTimerCallback(TimerHandle_t xTimer) {
  os_tim_interrupt_manager.HandleInterrupt(xTimer);
}

extern "C" inline void HW_TimBaseCallback(TIM_HandleTypeDef* htim) {
